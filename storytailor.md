...
* Story can be used as:
  ...
  * Unit of knowledge:
    ...
    * Motivate yourself.
* Story may include notes & visualizations that simplify understanding of the case.
...
Definition is a text that simplifies understanding of the term.

Notes:
* Definition may be generated from object.
  * Example:
    * "Alice" definition may be generated from User object (`{email: 'alice@example.com'}`) 
* Definition may be specified manually.
  * Example:
    * "Direct acquisition method" definition may be specified manually.
    
### Project

Project is a rendered collection of stories, definitions, FAQs.

Notes:
* Project is just a container for related content.
